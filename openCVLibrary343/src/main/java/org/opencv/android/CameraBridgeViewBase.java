...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public boolean isForgat() {
        return forgat;
    }

    public void setForgat(boolean forgat) {
        this.forgat = forgat;
    }

    public boolean forgat = false;
    ...
    private void updateMatrix() {
        ...
        isFrontCamera = mCameraIndex == CAMERA_ID_FRONT;
        ...
        Log.d("open_cv", "camera id: " + mCameraIndex);

        if (isForgat() == true || getmCameraIndex() == 0 || mCameraIndex == 99 || mCameraIndex != 1) {
            Log.d("open_cv", "forgat");
